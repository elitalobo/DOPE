...
if __name__ == '__main__':
    ...
    # env = rl_basics.domains_for_bilevel.cancer.EnvCancer(transition_noise=0.0)
    # policy_behavior = rl_basics.domains_for_bilevel.cancer.PolicyCancer(eps_behavior=0.3)
    # num_traj = 20
    ...
    # env = rl_basics.domains_for_bilevel.cancer.EnvCancer(transition_noise=0.05)
    # policy_behavior = rl_basics.domains_for_bilevel.cancer.PolicyCancer(eps_behavior=0.3)
    # num_traj = 20

    ''' Bad influential transitions '''
    # env = rl_basics.domains_for_bilevel.cancer.EnvCancer(transition_noise=0.2)
    # policy_behavior = rl_basics.domains_for_bilevel.cancer.PolicyCancer(eps_behavior=0.3)
    # num_traj = 20
